...
%{?dlrn: %global tarsources ironicclient}
%{!?dlrn: %global tarsources ironicclient}
...
Source0:        https://tarballs.openstack.org/python-%{sname}/python-%{tarsources}-%{upstream_version}%{?milestone}.tar.gz
# Required for tarball sources verification
%if 0%{?sources_gpg} == 1
Source101:        https://tarballs.openstack.org/python-%{sname}/python-%{tarsources}-%{upstream_version}%{?milestone}.tar.gz.asc
